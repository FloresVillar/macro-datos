...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("TransaccionesPorPais");
		...
		configuracion_job.setMapperClass(TransaccionesPorPais.Mapper.class);
		configuracion_job.setReducerClass(TransaccionesPorPais.Reducer.class);
