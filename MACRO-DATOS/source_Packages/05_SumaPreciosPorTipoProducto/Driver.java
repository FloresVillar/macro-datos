...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("SumaPreciosPorTipoProducto");
		...
		configuracion_job.setMapperClass(SumaPreciosPorTipoProducto.Mapper.class);
		configuracion_job.setReducerClass(SumaPreciosPorTipoProducto.Reducer.class);
