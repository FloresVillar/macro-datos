...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("TransaccionesPorCiudad");
		...
		configuracion_job.setMapperClass(TransaccionesPorCiudad.Mapper.class);
		configuracion_job.setReducerClass(TransaccionesPorCiudad.Reducer.class);
