...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("TarjetaMasUsadaPorCiudadPais");

		// Especificar el tipo de dato de la key y el value de salida
		// (acá son Text/Text porque el resultado es el nombre de una tarjeta, no un número)
		...
		configuracion_job.setMapperClass(TarjetaMasUsadaPorCiudadPais.Mapper.class);
		configuracion_job.setReducerClass(TarjetaMasUsadaPorCiudadPais.Reducer.class);
