...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("PrecioMasBaratoProduct1");
		...
		configuracion_job.setMapperClass(PrecioMasBaratoProduct1.Mapper.class);
		configuracion_job.setReducerClass(PrecioMasBaratoProduct1.Reducer.class);
