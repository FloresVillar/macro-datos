...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("SumaPreciosPorProductoYPago");
		...
		configuracion_job.setMapperClass(SumaPreciosPorProductoYPago.Mapper.class);
		configuracion_job.setReducerClass(SumaPreciosPorProductoYPago.Reducer.class);
