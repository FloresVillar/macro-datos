...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("BuscarUnitedKingdom");
		...
		configuracion_job.setMapperClass(BuscarUnitedKingdom.Mapper.class);
		configuracion_job.setReducerClass(BuscarUnitedKingdom.Reducer.class);
