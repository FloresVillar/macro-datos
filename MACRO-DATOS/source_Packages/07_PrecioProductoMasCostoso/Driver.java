...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("PrecioProductoMasCostoso");
		...
		configuracion_job.setMapperClass(PrecioProductoMasCostoso.Mapper.class);
		configuracion_job.setReducerClass(PrecioProductoMasCostoso.Reducer.class);
