...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("SumaPreciosProductos");
		...
		configuracion_job.setMapperClass(SumaPreciosProductos.Mapper.class);
		configuracion_job.setReducerClass(SumaPreciosProductos.Reducer.class);
